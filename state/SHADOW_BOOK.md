...
## Weekly refresh — 2026-09-07 (Monday AM)

Three tranches closed since the 2026-08-31 refresh: XLM (full exit of the final eighth, 2026-09-02 AM, thesis Playing Out→Stalled on the PM 09-01 trim's named reclaim conditions not met), ETH (staged-cut, 2026-09-05 AM, non-confirmation), LINK (staged-cut, 2026-09-05 PM, non-confirmation, fresh overextension override per LESSONS.md #16). Virtual continuation — mark the exited quantity at today's price (2026-09-07 AM, `parameters.py` generated_at 07:13:27Z for LINK/ETH; XLM sourced from the Binance spot data-mirror `data-api.binance.vision`, since XLM rotated off the watchlist 2026-08-24 and no longer refreshes via `parameters.py`) against original cost basis, vs. what was actually realized:

| Ticker | Exited qty @ avg cost | Realized P&L | Current price | Virtual mark-to-now | Virtual P&L (vs cost) | Divergence |
|---|---|---|---|---|---|---|
| XLM | 660.9103 @ $0.188543 | -$61.43 | $0.1901 | $125.64 | +$1.03 | +$62.46 |
| ETH | 0.2 @ $2454.07 | +$0.10 | $2501.42 | $500.28 | +$9.47 | +$9.37 |
| LINK | 41.837115 @ $11.728 | +$11.92 | $13.384 | $559.95 | +$69.28 | +$57.36 |

**Total realized across the three: -$49.41. Total virtual (if none had been cut/exited): +$79.78. Opportunity cost: +$129.19 on the $10,000 book** — a positive divergence again (real-book decisions beat holding), the second consecutive weekly reading in this direction after the -$21.54 read at 08-31, following the -$1,125.60 peak divergence at 08-24. XLM is the standout: its final-eighth cut (Weakening/Stalled call on the PM 09-01 trim's own named reclaim test) preceded a further ~-1.8% drift before a partial recovery to $0.1901 — the cut avoided the worse of the intervening drawdown even after the bounce, unlike the false-negative pattern LESSONS.md #7/#10 named. ETH and LINK's staged-entry non-confirmation cuts both cost a small amount in hindsight (+$9.37 and +$57.36 respectively) but both were flat-to-small-gain in realized terms too — mechanically correct rule application on thin signals, not costly misses. Two consecutive positive-divergence weeks (08-31, 09-07) after five consecutive negative ones (08-17 through 08-24-adjacent reads) is worth flagging for the next monthly review as a possible regime-dependency signal (LESSONS.md #7(b)'s hypothesis that the false-negative pattern tracks the market-wide melt-up rather than a durable rule flaw) — not yet enough readings to revise anything.

No confirmed candidates were rejected for a slot this week (LINK, ETH, and ETHFI all confirmed into open slots between 08-31 and this checkpoint, no EV tie-break competition) — nothing to add on that front.

## Rejected confirmed-candidate — XRP — 2026-09-07 PM

**Second real slot competition among confirmed candidates** (first was AAVE, 2026-08-26 AM). XRP confirmed 7/10 Bullish (0/10 Bearish) at 2 consecutive checkpoints (AM 09-07 7/10 armed -> PM 09-07 7/10 confirmed), tied with BNB (also confirmed 7/10, 0/10 Bearish this checkpoint) for the book's one open slot (4/5 positions held pre-entry: MORPHO, JUP, ETH, ETHFI). Per Section 5 step 6, tied confluence counts break on EV: **BNB +3.47% > XRP +3.27%** — XRP lost the tie-break by a narrow margin (0.20 points of EV), driven by a lower stated p (0.42 vs BNB's 0.45) reflecting XRP's more speculative contrarian-capitulation setup (a rangebound permanent-slot thesis betting on a break above the long-standing $1.40 psychological resistance) versus BNB's cleaner momentum-continuation setup (OI-confirmed breakout already underway).

**Virtual entry (for tracking only, no capital deployed):**
- Entry: $1.3956 (2026-09-07 PM, `parameters.py` generated_at 2026-09-07T19:06:11Z)
- Target: $1.65 (+18.2%, next major resistance above the long-standing $1.40 old-cycle chart level) | Invalidation: $1.29 (-7.6%, just under the 200DMA $1.274413) | R = 2.41 | stated p = 0.42 | EV = +3.27%
- Virtual size: 7.5% staged-half equivalent, i.e. tracked as if 741.4264/1.3956 = 531.245 XRP were bought at $1.3956 (matching BNB's actual staged-half notional for an apples-to-apples comparison).
...
## Weekly refresh — 2026-09-14 (Monday AM)

Two tranches closed since the 2026-09-07 refresh: AAVE (staged-cut 2026-09-08 PM, non-confirmation — the anti-churn-winning half that displaced MORPHO, see the paired comparison below), ETHFI (full exit 2026-09-12 PM, named thesis-test breach on sustained RSI-overextension after the 09-12 AM trim). Virtual continuation — mark the exited quantity at today's price (2026-09-14 AM, `parameters.py` generated_at 07:07:32Z) against original cost basis, vs. what was actually realized:

| Ticker | Exited qty @ avg cost | Realized P&L | Current price | Virtual mark-to-now | Virtual P&L (vs cost) | Divergence |
|---|---|---|---|---|---|---|
| AAVE | 3.76544 @ $131.06 | -$7.04 | $126.14 | $474.97 | -$18.53 | -$11.48 |
| ETHFI | 864.2608 @ $0.574441 | +$273.99 | $0.6606 | $570.93 | +$74.46 | -$199.52 |

**Total realized across the two: +$266.94. Total virtual (if neither had been cut/exited): +$55.94. Opportunity cost: -$211.01 on the $10,000 book** — a strongly positive divergence (real-book decisions beat holding by a wide margin), driven almost entirely by ETHFI: exiting the full position on the 09-12 PM overextension breach (RSI 76.8, no reclaim, new hold-high 47.5% dev-from-50DMA) captured the top before the token gave back roughly a quarter of its value into this checkpoint's $0.6606 mark — a clean validation of LESSONS.md hypotheses #18/#19's binary-confirmation-window rule. AAVE's staged-entry non-confirmation cut also came out ahead of holding (-$7.04 realized vs. -$18.53 virtual), a smaller but consistent data point for the same "no rule provides for adding off a confluence read alone, and cutting on non-confirmation is not a false negative here" pattern seen throughout the book's history.

**MORPHO exited-position virtual continuation, due today** (anti-churn displacement, 2026-09-08 AM, see entry above): qty 174.417 @ avg cost $2.485638 (cost basis $433.54), marked at today's $2.227 → value $388.43, virtual P&L **-$45.11** (vs. its own realized -$12.15 at exit — holding would have cost roughly $32.96 more than the actual exit did). **Paired comparison against AAVE, the anti-churn winner:** AAVE's real position (the same-day displacement winner) was itself staged-cut on non-confirmation the very next checkpoint (09-08 PM) for a total realized -$7.04 (never added the second half). Combined real outcome of the anti-churn decision (enter AAVE, cut on non-confirmation) = **-$7.04**, vs. MORPHO's virtual continuation of **-$45.11** if the displacement had never happened — the anti-churn call outperformed simply holding MORPHO by **+$38.07**, a clean confirmation that displacing a softening-but-not-broken holding for a fresh higher-confluence confirmation was the right capital-velocity call, even though the winning position itself didn't ultimately add the second half.

**XRP rejected-candidate virtual entry, due today** (EV tie-break loss to BNB, 2026-09-07 PM): virtual qty 531.245 @ entry $1.3956 (cost basis $741.41), marked at today's $1.3878 → value $737.26, virtual P&L **-$4.14** (-0.56% vs. entry, essentially flat — neither target $1.65 nor invalidation $1.29 threatened). Compares against BNB's real position, the tie-break winner: BNB's actual unrealized P&L on its matching-notional half-tranche is **-$40.42** (qty 1.991726 @ avg cost $744.5063, now $724.21, -2.73%). At this reading the tie-break's loser (XRP, virtual) is running **+$36.28 ahead** of the tie-break's winner (BNB, real) — a live data point against the EV tie-break's stated edge (BNB's higher stated p, 0.45 vs 0.42, on a cleaner OI-confirmed-breakout setup) not yet playing out; still early (one week in, both readings essentially small moves either side of flat) and not enough to revisit the tie-break mechanism, but worth carrying forward to the next refresh.

No confirmed candidates were rejected for a slot this week (AAVE, ETH, TRX, JUP, BNB, TRX all confirmed/held into existing slots or were already-held positions between 09-07 PM and this checkpoint — no new EV tie-break competition) — nothing new to add on that front. SOL armed 7/10 (0 Bearish) this AM checkpoint (first occurrence, PM 09-13 was 5/10) — not yet a confirmed candidate, nothing to track here until/unless it confirms and then loses a slot competition.
