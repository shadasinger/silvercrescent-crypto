...
- Scripts: `python3 scripts/parameters.py` (needs `state/WATCHLIST.json`), `python3 scripts/universe.py` (writes `data/universe.json`). Stdlib only, no pip installs needed.
